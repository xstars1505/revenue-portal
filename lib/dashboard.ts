...
export type RevenueMonth = { month: string; revenue: number; cogs: number; opex: number; source: string };
...
export const delta = (current: number, comparison: number) => ((current / comparison) - 1) * 100;
